        ...
        <div className="relative mx-auto flex min-h-[70vh] max-w-screen-2xl flex-col justify-center px-4 py-32 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="group inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-base font-medium text-black transition-opacity hover:opacity-90"
            >
              Nous écrire
            ...
            <Link
              href="/solutions"
              className="rounded-lg border border-white/30 px-6 py-3 text-base font-medium text-white transition-colors hover:bg-white/10"
            >
